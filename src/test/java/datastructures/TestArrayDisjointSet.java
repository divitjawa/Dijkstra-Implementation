...
public class TestArrayDisjointSet extends BaseTest {
    ...
    @Test(timeout=SECOND)
    public void testUnionEqualTrees() {
        String[] items = new String[] {"a", "b", "c", "d", "e"};
        IDisjointSet<String> forest = this.createForest(items);
        ...
        for (int i = 0; i < 5; i++) {
            check(forest, items, new int[] {id2, id2, id2, id2, 4});
        }
    }
    ...
    @Test(timeout=SECOND)
    public void testCompressesPathCorrectly() {
        String[] newItems = new String[] {"a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k"};
        IDisjointSet<String> forest = this.createForest(newItems);
        ...
        int id2 = forest.findSet("d");
        assertEquals(0, id2);

        forest.union("d", "e");
        int id3 = forest.findSet("e");
        assertEquals(0, id3);
    }
